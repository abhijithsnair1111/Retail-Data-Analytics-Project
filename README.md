...
This project is build upon fictional retail data generated by **LLMs** based on **Real Life Business Scenarios** and underwent a complete **ETL Process**

---

## Project Overview 🪛

Analyze and Create Reports for a retail chain to answer business questions and provide insights into future decision making. This include in depth analysis and generating answers for all the existing business questions.

The Processes:

- **Exploratory Data Analysis:** Explore the Database to understand all structure and basic details regarding the content
  
- **Advanced Analytics:** Use advance methods to form complex calculations and generate insights for reports
...
The first part of this project is **Data Analysis**. Exploring and Understanding the data to extract patterns, and further manipulating it using advance methods form complex results  
...
- **Database Exploration**
  - Purpose: Explore the structure of the Database. Understand the Tables and their Schemas, explore all the Columns and its metadata
...
- **Date Exploration**
  ...
  - Insights: Extracted the first and last Order Date and the months in between them, Extracted the oldest and youngest customer
 
- **Magnitude Analysis**
  - Purpose: Understand data distributions across categories. Group measures by dimensions
  - Script: [`magnitude_analysis `](scripts/05_magnitude_analysis.sql)
  - Insights: Extracted several aggregations by categories such as Total Customers by Countries/Gender, Total Products by Categories
...
### Advanced Analytics
The purpose of the Advanced Analytics is to understand the data in depth by forming complex calculations to extract insight and generate comprehensive reports

- **Change Over Time Analysis**
  - Purpose: Track trends, growth and changes in key values over time. Understand performance of over time
  - Script: [`change_over_time_analysis`](scripts/07_change_over_time_analysis.sql)
  - Insights: Analyzed Sales performance over time
...
- **Cumulative Analysis**
  ...
  - Insights: Calculated Running Total Sales and Moving Average Prices
 
- **Performance Analysis**
  - Purpose: Calculate the Performance of a metrics by itself over time. Year Over Year analysis
...
- **Part To Whole Analysis**
  - Purpose: Calculate the proportion of a metric in a given category compared to the whole aggregated value
...
- **Data Segmentation Analysis**
  ...
  - Insights: Segmented products into cost ranges and counted the number of products in each segment
...
- What is the overall sales performance of the retail chain over the last 5 years ?
  - The overall sales performance of the retail chain has be fluctuating through out the last 5 years
...
- [x] Provide clear documentation regarding the entire process in a easy to access format
